# Scalable Studentized Bootstrap Variance Inference via Linear-Time Pairwise Difference Computation

This repository contains code, data, and supplementary materials to reproduce the main results from the manuscript:

**Title:** Scalable Studentized Bootstrap Variance Inference via Linear-Time Pairwise Difference Computation  
**Authors:** Sudesh K. Srivastav, Apurv Srivastav  
**Target journal:** Communications in Statistics – Simulation and Computation (CSSC)  
...
│   ├── large_sample_variance_summary.csv
│   └── real\_data\_results.rds
└── figures/
    ├── Figure2_coverage_color
    └── Figure3_LargeSampleCoverage_color
    ├── figure4_sensitivity_B_plot
