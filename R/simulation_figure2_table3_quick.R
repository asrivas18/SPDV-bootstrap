...
# ============================================================================
saveRDS(coverage_results, "coverage_results_quick.rds")
write.csv(coverage_results, "coverage_results_quick.csv", row.names = FALSE)
...
ggsave("Figure2_Coverage_JSCS_quick.pdf",
       p_JSCS,
       width = 12,
       height = 10,
       dpi = 300)
...
ggsave("Figure2_Coverage_color_quick.pdf",
...
cat("\nSimulation complete.\n")
cat("Files saved: coverage_results_quick.rds, coverage_results_quick.csv, Figure2_Coverage_JSCS_quick.pdf, Figure2_Coverage_color_quick.pdf\n")